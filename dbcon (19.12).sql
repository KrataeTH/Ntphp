...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 19, 2024 at 04:16 AM
...
(140, NULL, NULL, NULL),
(141, NULL, 7101, 710101),
(142, NULL, 7101, 710102),
(143, NULL, NULL, NULL);
...
(78, 'Papa', 'เทศบาลเมือง', 'ย.09755884321', 'Active', 141, '2024-12-19', '2024-12-19'),
(79, 'Mama', 'เทศบาลตำบล', 'ก.05087544861', 'Active', 142, '2024-12-19', '2024-12-19'),
(80, NULL, NULL, NULL, NULL, 143, '2024-12-19', '2024-12-19');
...
--
ALTER TABLE `address`
  MODIFY `address_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=144;
...
--
ALTER TABLE `bill_group`
  MODIFY `bill_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
